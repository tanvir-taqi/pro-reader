...
const Home = ({dark}) => {
  return (
    <div className='px-4 py-32 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-24'>
      <div className='flex flex-col items-center justify-between lg:flex-row'>
        <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
          <div className='max-w-xl mb-6 lg:mt-8'>
            ...
            <h2 className={`max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight ${dark ? 'text-gray-400' :'text-gray-900' } sm:text-4xl sm:leading-none`}>
